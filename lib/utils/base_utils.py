# copy from https://github.com/zju3dv/EasyVolcap/blob/main/easyvolcap/utils/base_utils.py
from __future__ import annotations

from copy import copy
from typing import Callable, Dict, Iterable, List, Mapping, TypeVar, Union
            ...
            if k in self:
                ...
                if not isinstance(v, target_type):
                    ...
                    if target_type == bool and isinstance(v, str):
                        ...
                        if isinstance(v, torch.Tensor) and not issubclass(
