# copy from https://github.com/zju3dv/EasyVolcap/blob/main/easyvolcap/utils/console_utils.py
...
from typing import IO, Any, Callable, Dict, Iterable, List, Optional, Type, Union, cast
...
from .base_utils import DoNothing, default_dotdict, dotdict
